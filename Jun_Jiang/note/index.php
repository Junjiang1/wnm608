...
<body>
	...
	<nav class="flex-none nav">
		<ul class="container display-flex">
			...
			<li><a href="#article2">Product list</a></li>
	...
	<!-- .coontainer>article#article$.article*4>h2{Article $}+div.article-body>p*3>lorem40 -->
	...
	<div class="container">
		...
		<div class="view-window" style="background-color: darkgray;">
		...
		<div class="container">
			<h3 class="company">Organic Food</h3>
            <div class="grid gap">
            ...
            <div class="container">
            	<h3 class="company">Super Food</h3>
